...
if __name__ == '__main__':  # Execute the following code only when executing main.py (not when importing it)
    ...
    binance = BinanceClient("BTDMi6G9pGBCkaX1muTOwzboFsccZ43DjJS5LFXROZ9XO0SnQctK1HvqBf6t5eTl",
                            "JcUuyOtbULdT88XFw8gcy4JIJ1BnzqrqNIgtfLs9kBTLridJRd1ZQ7iKsKQX8d3r",
                            testnet=True, futures=True)
    bitmex = BitmexClient("ZT-cvxWSqyzLTpg748Vg5FM7", "KT-0AwEBCPdgQpSWq2PeJ4Rt2Kb3AqHMjRUAQadhtvDdZ5ev", testnet=True)
